...
/*   Updated: 2021/12/23 13:10:22 by ajimenez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx->block = ft_create_image(mlx->block, mlx->ptr,
			"./sprites/wall_sprite.xpm");
	mlx->floor = ft_create_image(mlx->floor, mlx->ptr,
			"./sprites/floor_sprite.xpm");
